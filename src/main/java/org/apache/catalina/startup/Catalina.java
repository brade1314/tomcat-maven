...
public class Catalina {
    ...
    /**
     * 解析 server.xml 文件, 创建 StandardServer
     * @param start
     */
    ...
    public void start() {
        ...
        // Start the new server
        try {
            // createStartDigester() 里解析 server.xml , 设置规则
            // 调用 StandardServer.startInternal()
            // -> SandardService.startInternal()
            // -> Connector.startInternal()
            // -> StandardEngine.startInternal()
            // -> StandardHost.startInternal()
            // -> ContainerBase.startInternal()
            // -> StardardContext.startInternal()
            // -> StardardWrapper.startInternal()
