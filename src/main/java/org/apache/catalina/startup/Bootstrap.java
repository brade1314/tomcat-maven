...
public final class Bootstrap {
    ...
    /**
     * 类加载器,根据 catalina.properties 文件加载对应包下面的 jar 包
     * @param name
     * @param parent
     * @return
     * @throws Exception
    ...
    public void init() throws Exception {
        ...
        initClassLoaders();
        // 将 catalinaLoader 设置为主线程的线程上下文类加载器
        Thread.currentThread().setContextClassLoader(catalinaLoader);
        // 加载 server.loader 配置的 class
        ...
        // 使用反射实例化 Catalina ,调用 setParentClassLoader 方法 , 设置共享扩展类加载器 sharedLoader
    ...
    /**
     * Load daemon. 调用 Catalina.load() 方法
     */
